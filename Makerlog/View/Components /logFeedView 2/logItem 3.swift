...
struct logItem: View {
    @ObservedObject var data: logViewData
    
    var body: some View {
        NavigationLink(destination: LogView(log: logViewData(data: self.data.data), comments: commentViewData(logID: String(log.id)))) {
